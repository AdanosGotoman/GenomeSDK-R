...
{
public:    virtual HWND  GetWindowHandle( void );
...
public:    virtual void  ProcessNextMessage( MSG &, GEBool &, GEBool &, GEBool );
...
protected:
    GEBool m_bEnabled;
    GEBool m_bIdleActivated;
    GEBool m_bRedirected;
    GEBool m_bTerminated;
...
GE_ASSERT_SIZEOF( eCMessageHandler, 0x0010 )
