...
{
public: virtual FFU32  Read( FFLPVoid,  FFU32 ) const    = 0;  
public: virtual FFU32  Write( FFLPCVoid, FFU32 )         = 0;  
public: virtual FFBool GetPosition( FFI64 & ) const      = 0;  
public: virtual FFBool SetPosition( FFI64, EFFFileSeek ) = 0;  
public:
