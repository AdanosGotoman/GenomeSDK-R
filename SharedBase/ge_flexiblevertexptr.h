...
{
private:
    bCFlexibleVertexFormat m_fvfFormat;
    GEU8 *                 m_pu8Buffer;
public:
    GEU8 * &                       AccessBuffer( void );
    ...
    void                           Advance( GEInt );
    void                           AttachTo( bCFlexibleVertexFormat const &, GEU8 * );
    void                           CopyFrom( bCFlexibleVertexPtr const & );
    void                           CopyTo( bCFlexibleVertexPtr & ) const;
    GEU8 *                         GetBuffer( void );
    GEU8 const *                   GetBuffer( void ) const;
    void                           GetBuffer( GEU8 * & ) const;
