...
public:
    enum bEEdge
    {
        //FIXME: bCOrientedBox::bEEdge constants.
        bEEdge_Count = 12,
        bEEdge_ForceDWORD = GE_FORCE_DWORD
    };
    enum bEPlane
    {
        //FIXME: bCOrientedBox::bEPlane constants.
        bEPlane_Count = 6,
        bEPlane_ForceDWORD = GE_FORCE_DWORD
    };
    enum bEVertex
    {
        //FIXME: bCOrientedBox::bEVertex constants.
        bEVertex_Count = 8,
...
public:
    ...
    void              GetEdges( bCStretch [ bEEdge_Count ] ) const;
    ...
    void              GetPlanes( bCPlane [ bEPlane_Count ] ) const;
    ...
    void              GetVertices( bCVector [ bEVertex_Count ] ) const;
