...
public:
    ...
    void             SetToInverse( bCMatrix3 const & );                     // inline local: static bCMatrix3 matInverted;
    void             SetToProduct( bCMatrix3 const &, bCMatrix3 const & );  // inline local: static bCMatrix3 matProduct;
...
public:
    ...
    explicit bCMatrix3( bCVector const [ bERow_Count ] );
    explicit bCMatrix3( GEFloat const [ bEElement_Count ] );
    explicit bCMatrix3( GEFloat const [ bERow_Count ][ bEColumn_Count ] );
